...
<p>Category :
<input type="text" name="category" class="form-control" required></p>
<p>Description :
<input type="text" name="des" class="form-control" required></p>
<p>Room Number :
<input type="text" name="roomno" class="form-control" required></p>
</div>
