  ...
  $teamid = uniqid();
   ...
   ,  teamid) 
    ...
    if(!empty($l_email)) {
      ...
      $mail->isHTML(true);
      $mail->Subject = 'Welcome to Hostel-night family';
      $mail->Body = "
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <div id="example3">        
<form method="post" class="p-3" id="form3" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }">
...
<select class="form-control classic" name="category" id="test"  onchange="showDiv()" >
                <option value="1" selected>Instrumental Solo </option>
...
<p>Choose Number of Team Members : </p>
        <div class="form-group" >
         ...
         <option value="1_one"  style="display:none;">Choose Here</option>
              
                <option value="1_one" selected="selected">One</option>
...
$(document).ready(function() {
    ...
    $("#test").change(function() {
        ...
        document.getElementById("seeAnotherFieldGroup").selectedIndex = "0";
      //  document.getElementById("seeAnotherFieldGroup").value = " + $(this).val() + ";
